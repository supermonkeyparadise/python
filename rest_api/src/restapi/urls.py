...
from updates.views import (json_example_view, json_shortcutExample_view,
                           JsonCBV, JsonCBV2, SerializedListView, SerializedDetailView)

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'^json/example/$', json_example_view),
    url(r'^json/example/shortcut/$', json_shortcutExample_view),
